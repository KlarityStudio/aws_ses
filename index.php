...
$recipient = 'kurvinhendricks@gmail.com';
$cc = 'kurvindroid@gmail.com,kurvintwitter@gmail.com';

//setting recipients to cc for now, to allow for mulitple recipients.

$status = $mailer->SendEmailToClient($recipient, 'thisisatestmailerhere', $body, $cc);
